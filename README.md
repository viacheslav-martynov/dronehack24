...
### Важно! 
Уважаемый Эксперт! 
Мы подготовили три модели: 

1. Baseline
2. Baseline+TTA
3. Baseline+TTA+SAHI

Основная модель для тестирования на фотографиях и видео - Baseline+TTA. Однако, Baseline+TTA+SAHI тоже может дать лучшую точность, но скорость будет значительно ниже. Начните, пожалуйста, с версии Baseline+TTA, а также попробуйте Baseline+TTA+SAHI. Спасибо!
